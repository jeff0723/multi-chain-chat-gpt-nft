...
export class GovernorPreventLateQuorum extends BaseContract {
  ...
  filters: {
    ...
    "LateQuorumVoteExtensionSet(uint64,uint64)"(
      ...
      [BigNumber, BigNumber],
      { oldVoteExtension: BigNumber; newVoteExtension: BigNumber }
    >;
    ...
    "ProposalExtended(uint256,uint64)"(
      ...
      [BigNumber, BigNumber],
      { proposalId: BigNumber; extendedDeadline: BigNumber }
    >;
